...
parser.add_argument('-a','--arch',required=True)  # This line is homework1 specific
...
def load_data(cifar = None, one_hot_labels = False, normalize = False, flatten = True, full=None):
    ...
    if args.full or (full is not None and full):
        if args.tiny:
